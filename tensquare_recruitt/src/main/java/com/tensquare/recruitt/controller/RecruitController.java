package com.tensquare.recruitt.controller;

import com.tensquare.recruitt.pojo.Recruit;
import com.tensquare.recruitt.service.RecruitService;
...
public class RecruitController {
    ...
    public Result recommend() {
        ...
        return new Result(true, StatusCode.OK, "查询推荐成功", recruits);
    }

    @RequestMapping(value = "/search/newlist", method = RequestMethod.GET)
    public Result newList() {
        List<Recruit> recruits = recruitService.findTop12ByStateNotOrderByCreatetimeDesc("0");
        return new Result(true, StatusCode.OK, "查询推荐成功", recruits);
    }
