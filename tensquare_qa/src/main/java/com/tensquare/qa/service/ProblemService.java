...
public class ProblemService {
    ...
    public PageResult<Problem> findNewList(String labelid, int page, int pageSize) {
        Pageable pageable = PageRequest.of(page - 1, pageSize);
        Page<Problem> pageList = problemDao.findNewListByLabelId(labelid, pageable);
        return new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent());
    }

    public PageResult<Problem> findHotList(String labelid, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<Problem> pageList = problemDao.findHotList(labelid, pageable);
        return new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent());
    }

    public PageResult<Problem> findWaitList(String labelid, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<Problem> pageList = problemDao.findWaitList(labelid, pageable);
        return new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent());
    }
